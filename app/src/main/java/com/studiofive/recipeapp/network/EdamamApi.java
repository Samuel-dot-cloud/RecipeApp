...
public interface EdamamApi {
    ...
    @GET("search")
    Call<List<Hit>>getRecipe(@Query("q") String recipe, @Query("app_id")String app_id, @Query("app_key")String app_key, @Query("from")String from, @Query("to") String to, @Query("calories")String calories, @Query("health")String health);
